...
@if( isset($pedidosCompras) )
  ...
  @endif  
    ...
    <div class="form-group">
      ...
      <input type="text" onkeyup="pressedCodBarrasAndQtdAndCPF()" name="Quantidade" maxlength="100" value="{{ $pedidosCompras->Quantidade or old('quantidadeProduto')}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" class="form-control" id="Quantidade" placeholder="Digite a quantidade">
      <div class="invalid-feedback">
    ...
    <div class="form-group">
      ...
      <input type="text" name="CPF_cliente" onkeyup="pressedCodBarrasAndQtdAndCPF()" maxlength="11" value="{{ $pedidosCompras->CPF_cliente or old('cpfCliente')}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57;" class="form-control" id="CPFCliente" placeholder="Digite o CPF do cliente">
      <div class="invalid-feedback">
